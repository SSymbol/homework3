...
train_data = pd.read_csv('e:/hw3/data/train.csv')
test_data = pd.read_csv('e:/hw3/data/test.csv')
test_label = pd.read_csv('e:/hw3/data/gender_submission.csv')
result = open('e:/hw3/result/classification_result.txt','a+')
...
plt.savefig('e:/hw3/output/classification_result1_dtc.png')
plt.clf()
...
ax.set_ylabel('sibsp')
ax.set_zlabel('pclass')
plt.savefig('e:/hw3/output/classification_result2_dtc.png')
plt.clf()
...
ax.set_ylabel('sibsp')
ax.set_zlabel('pclass')
plt.savefig('e:/hw3/output/classification_result1_rfc.png')
plt.clf()
...
ax.set_ylabel('SibSp')
ax.set_zlabel('pclass')
plt.savefig('e:/hw3/output/classification_result2_rfc.png')
plt.clf()
